...
/**cache these files in persistent storage, so they don't have to be downloaded
 * every time the app loads or changes configuration.
 * - Using my class ImageCacheManage*/
